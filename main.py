...
if __name__ == '__main__':
        ...
        if  Radio=='Home':
                st.markdown("<h1 style='text-align: center; color: black;'><center>Applying BERT Fine Tuning to SentimentClassification on Amazon Reviews.</center></h1>", unsafe_allow_html=True)
        ...
        if Radio=='Beto':
                st.text_input("")
                st.markdown("<h1 style='text-align: center; color: blue;'> Spanish BERT </h1>", unsafe_allow_html=True)
        ...
        if Radio=='MBert':
                st.text_input("")
                st.markdown("<h1 style='text-align: center; color: blue;'> Multilingual BERT </h1>", unsafe_allow_html=True)
                st.header("Press the buttom to predict your senteces.")
                frase = st.text_input("Ingrese una frase")
        ...
        if Radio=='About':        
                st.markdown("<h1 style='text-align:left; color: black;'><center>About</center></h1>", unsafe_allow_html=True)
                st.title("Me")
